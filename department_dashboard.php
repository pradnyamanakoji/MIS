...
echo "<h2>Welcome Department User: " . $_SESSION['user'] . "</h2>";
echo "<p>Department: " . $_SESSION['dept'] . "</p>";
?>
...
<body>
  ...
  <div class="button-grid">
    <a href="sheet1.php" class="button">प्रलंबित सेवानिवृत्त प्रकरणांच</a>
    <a href="#" class="button">तालुकानिहाय यादी</a>
    <a href="pending_family_pension.php" class="button">प्रलंबित कुटूंब निवृत्तीवेतन प्</a>
    ...
    <a href="form3.php" class="button">न्यायालयीन प्रकरणांबाबतची माहित</a>
  </div>
